export const activateEmailTemplate = (to, url) => {
    ...
    <tr>
    <td align="center" style="padding:0;Margin:0;font-size:0px"><a target="_blank" href="https://ColomboCFC.com" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#134F5C;font-size:14px"><img class="adapt-img" src="https://res.cloudinary.com/db2sa2bxv/image/upload/v1676456828/logoCFC_yswlhx.svg" alt="ColomboCFC" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" height="34" title="ColomboCFC"></a></td>
    </tr>
    <tr>
